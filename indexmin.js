class MudiPixel{
    ...
    /** Events for DOM verification */
        ...
        verifyAddToCar(){
            ...
            let 
            element         = document.body.querySelector(`.single_add_to_cart_button`); // CUSTOM ELEMENT ✔️
        ...
        verifyCategory(){
            ...
            let 
            breadcrumb         = document.body.querySelector(`.woocommerce-breadcrumb`); // CUSTOM ELEMENT breadcrumb
            ...
            ? ( this.category       = breadcrumb.children[2].innerText, 
                this.subCategory    = breadcrumb.children[4].innerText, 
        ...
        verifyPurchase(){
            ...
            let 
            purchaseBtn         = document.body.querySelector(`.fc-place-order-button`); // CUSTOM ELEMENT breadcrumb
